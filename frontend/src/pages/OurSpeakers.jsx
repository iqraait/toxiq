...
import deoPhoto from '../assets/deo.png';
import abhiramPhoto from '../assets/abhiram.jpg';
import arjunPhoto from '../assets/arjun.png';
import ameenPhoto from '../assets/ameen.png';
import rinoopPhoto from '../assets/rinoop.png';
...
import vinayakMSPhoto from '../assets/vinayak_ms.png';
import vinayakSRPhoto from '../assets/vinayak_sr.png';
...
const OurSpeakers = () => {
  ...
  const getImageUrl = (path, name) => {
    if (name) {
      ...
      if (lowerName.includes('deo')) return deoPhoto;
      if (lowerName.includes('abhiram')) return abhiramPhoto;
      if (lowerName.includes('arjun') && !lowerName.includes('abhiram')) return arjunPhoto;
      if (lowerName.includes('ameen')) return ameenPhoto;
      if (lowerName.includes('rinoop')) return rinoopPhoto;
      ...
      if (lowerName.includes('vinayak m s') || lowerName.includes('vinayak ms')) return vinayakMSPhoto;
      if (lowerName.includes('vinayak s r') || lowerName.includes('vinayak sr') || lowerName.includes('vinayak')) return vinayakSRPhoto;
