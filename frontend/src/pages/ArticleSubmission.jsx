  ...
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }} className="gradient-bg">
      ...
      <Container maxWidth="md" sx={{ py: 6, flexGrow: 1 }}>
        ...
        {/* Guidelines & Templates Banner Box (Placed Above the Form Card) */}
        <GlassCard sx={{ 
          p: 4, 
          mb: 4, 
          border: '1px solid rgba(13, 148, 136, 0.12)', 
          boxShadow: '0 10px 30px rgba(13, 148, 136, 0.03)',
          ...
          <Box>
            <Typography variant="h6" fontWeight="800" color="primary.main" mb={1} sx={{ fontFamily: "'Raleway', sans-serif" }}>
              Guidelines & Templates
            </Typography>
            <Typography variant="body2" color="textSecondary" sx={{ lineHeight: 1.5, maxWidth: '600px' }}>
