  ...
  useEffect(() => {
    const fetchForm = async () => {
      try {
        ...
        setError('Failed to load the SpotRegistration form schema. Please contact system administrators.');
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.response?.status === 400) {
        ...
        setError('Network error during SpotRegistration. Please try again.');
      }
    } finally {
      setSubmitting(false);
    }
    ...
    return (
      <Box display="flex" justifyContent="center" alignItems="center" minHeight="100vh" className="gradient-bg">
        <Stack alignItems="center" spacing={2}>
          ...
          <Typography variant="body1" color="textSecondary">Building dynamic SpotRegistration portal...</Typography>
        </Stack>
      </Box>
    );
  }
      ...
      <Box minHeight="100vh" className="gradient-bg">
        ...
        <Container maxWidth="md" sx={{ py: 8 }}>
          <Alert severity="warning">
            <AlertTitle>SpotRegistration Offline</AlertTitle>
            SpotRegistration is currently closed or the form has not been constructed by Super Admin.
          </Alert>
        </Container>
      </Box>
    );
    ...
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }} className="gradient-bg">
      ...
      <Container maxWidth="lg" sx={{ py: 8, flexGrow: 1 }}>
        <Grid container spacing={4} justifyContent="center">
          ...
          {/* Main SpotRegistration Form */}
          <Grid item xs={12} md={10} lg={9}>
            
            {/* Section 1: SpotRegistration Details Banner Card */}
            <GlassCard sx={{ 
              p: 3, 
              mb: 4, 
              ...
              <img 
                src={SpotRegistrationBanner} 
                alt="SpotRegistration Details" 
                style={{ 
                  width: '100%', 
                  maxHeight: '520px', 
                  objectFit: 'contain', 
            ...
            {/* Section 2: SpotRegistration Form Inputs Card */}
            <GlassCard sx={{ 
              p: 4, 
              border: '1px solid rgba(30, 58, 138, 0.12)', 
            ...
            <Grid container spacing={3}>
                ...
                >
                  <Box mb={2}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Participant SpotRegistration starts
                    </Typography>
                  </Box>
                  <Chip 
                    label={formatDate(dates.SpotRegistration_open)} 
                    sx={{ 
                      fontWeight: '800', 
                      fontSize: '0.9rem',
              ...
              <Grid item xs={12} sm={4}>
                ...
                >
                  ...
                  <Chip 
                    label={formatDate(dates.SpotRegistration_close)} 
                    sx={{ 
                      fontWeight: '800', 
                      fontSize: '0.9rem',
